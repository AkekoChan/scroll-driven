  ...
  connectedCallback() {
    ...
    <div class="timeline__wrapper">
      ...
      <ul class="timeline__list">
        ...
        <li class="timeline__item">
          Timeline de progression d'affichage: une timeline liée à la position
          relative d'un élément spécifique.
        </li>
      </ul>
      ...
      <div class="timeline__view">
        ...
        <div class="timeline__view-example">
          <p class="timeline__view-text animation">
            Je suis le 1er à apparaître !
          </p>
          <p class="timeline__view-text animation">
            Je suis le 2ème à apparaître !
          </p>
          <p class="timeline__view-text animation">
            Je suis le 3ème à apparaître !
          </p>
          <p class="timeline__view-text animation">
            Je suis le 4ème à apparaître !
          </p>
          <p class="timeline__view-text animation">
            Je suis le 5ème à apparaître !
          </p>
        </div>
        ...
        <div
          ...
          aria-label="Détails de la timeline d'affichage"
        >
          <h3 class="timeline__title">Explication du fonctionnement</h3>
          <figure>
            <img
              class="timeline__view-img"
              src="/assets/img/view-explication1.jpg"
              alt="Schéma de présentation de la timeline view"
            />
            <figcaption>
          ...
          <figure>
            <img
              class="timeline__view-img"
              src="/assets/img/view-explication2.jpg"
              alt="Schéma de présentation de la timeline view"
            />
            <figcaption>
          ...
          <p class="timeline__paragraph">
            Cela est rendu possible grâce à la propriété CSS :
            <b>animation-timeline: view();</b>
          </p>
          <p class="code">
            .animation { 
